...
export default {
  ...
  created: function() {
    const {GetTodoRequest} = require('./lib/todos_pb.js');
    const {TodoServiceClient} = require('./lib/todos_grpc_web_pb.js');
    ...
    // this.client = new todoServiceClient(serverAddr, null, null);
    // this.getTodos();
  },
  methods: {
    // getServerAddr: function() {
    //   let serverAddr = `${document.location.origin}`;
