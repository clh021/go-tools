const {EchoRequest,
       ServerStreamingEchoRequest} = require('./lib/echo_pb.js');
const {EchoServiceClient} = require('./lib/echo_grpc_web_pb.js');
...
var echoService = new EchoServiceClient('http://'+window.location.hostname+':80801', null,
                                        null);
//                                      opts);
